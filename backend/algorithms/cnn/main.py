...
from algorithms.cnn.utils import CLASS_NAMES, IMAGE_SIZE

MODEL_PATH = os.path.join(backend_dir, "save_models", "custom_cnn", "potatoes.h5")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Predict using CNN")
