...
from algorithms.densenet.utils import CLASS_NAMES, IMAGE_SIZE

MODEL_PATH = os.path.join(backend_dir, "save_models", "densenet121", "DenseNet121_finetuned.h5")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Predict using DenseNet121")
